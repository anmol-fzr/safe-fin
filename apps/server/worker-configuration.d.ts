/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 747c1d8de4867d353a9a25ea4f3dc8e0)
// Runtime types generated with workerd@1.20260305.0 2022-07-12 export_commonjs_default,nodejs_compat
declare namespace Cloudflare {
	...
	interface ProdEnv {
		...
		TEST_CREDS_EMAIL: string;
		TEST_CREDS_OTP: string;
	}
	interface Env {
		CORS_ORIGIN_URL: string;
		BETTER_AUTH_SECRET: string;
