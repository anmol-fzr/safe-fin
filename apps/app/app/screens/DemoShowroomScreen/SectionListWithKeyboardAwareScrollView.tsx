...
type SectionListWithKeyboardAwareScrollViewProps<ItemType> =
...
export default forwardRef(SectionListWithKeyboardAwareScrollView) as <
	ItemType = any,
>(
