...
import { BoxTick, Check, TickCircle } from "iconsax-react-nativejs";
				...
				renderInitialContent={() => (
					<View style={styles.fabContent}>
						<View style={styles.fabTextContent}>
							<Text style={[styles.fabTitle]}>Complete</Text>
						</View>
						<View
							style={{
								position: "absolute",
						...
						>
							<CircularProgress
								...
								size={36}
								renderIcon={() => (
									<Icon icon="check" color={"#fff"} size={30} />
								)}
								strokeWidth={3}
								backgroundColor="#333"
							/>
			...
			>
				<View style={styles.content}>
					<View style={styles.badge}>
						<Text style={styles.badgeText}>Short Story</Text>
					</View>
