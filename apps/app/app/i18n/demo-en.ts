		...
		useCase: {
			variants: {
				...
				switch: {
					...
					helper:
						"A more prominent on/off input. Has better accessibility support.",
				},
			},
			statuses: {
				name: "Statuses",
			...
			passingContent: {
				...
				useCase: {
					...
					checkBoxMultiLine: {
						helper:
							"Supports multiline - Nulla proident consectetur labore sunt ea labore. ",
					},
					radioChangeSides: {
						helper:
							"You can change sides - Laborum labore adipisicing in eu ipsum deserunt.",
					},
					customCheckBox: {
	...
	demoListItem: {
		...
		useCase: {
			...
			customLeftRight: {
				...
				description:
					"If you need a custom left/right component, you can pass it in.",
			...
			listIntegration: {
				...
				description:
					"The component can be easily integrated with your favorite list interface.",
			},
			styling: {
				name: "Styling",
				description: "The component can be styled easily.",
	...
	demoHeader: {
		...
		useCase: {
			actionIcons: {
				name: "Action Icons",
				description:
					"You can easily pass in icons to the left or right action components.",
			...
			actionText: {
				name: "Action Text",
				description:
					"You can easily pass in text to the left or right action components.",
