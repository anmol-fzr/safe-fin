	...
	demoToggle: {
		...
		useCase: {
			...
			statuses: {
				...
				disabledStatus:
					"अक्षम स्थिति - संपादन को अक्षम करता है और इनपुट को मंद करता है",
			},
			passingContent: {
				name: "सामग्री पास करना",
				description: "सामग्री पास करने के कई तरीके हैं।",
				useCase: {
					...
					radioChangeSides: {
						helper:
							"आप पक्ष बदल सकते हैं - Laborum labore adipisicing in eu ipsum deserunt.",
					},
					customCheckBox: {
	...
	demoText: {
		...
		useCase: {
			...
			weights: {
				...
				semibold:
					"सेमीबोल्ड - Exercitation magna nostrud pariatur laborum occaecat aliqua.",
			...
			passingContent: {
				...
				children:
					"चिल्ड्रन - Aliqua velit irure reprehenderit eu qui amet veniam consectetur.",
