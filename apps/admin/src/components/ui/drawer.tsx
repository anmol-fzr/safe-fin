...
const drawerContentVariants = cva(
	"fixed z-50 flex h-auto flex-col border bg-background w-fit p-4",
	{
		variants: {
			direction: {
...
const DrawerHeader = ({
	...
	<div
		className={cn("grid gap-1.5 mb-6 text-center sm:text-left", className)}
		{...props}
	/>
);
...
const DrawerFooter = ({
	...
	<div
		className={cn("mt-auto flex flex-col gap-2 mt-4", className)}
		{...props}
	/>
);
